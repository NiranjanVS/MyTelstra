  ...
  return (
    <div>
      ...
      >
        ...
        <MenuItem><Link style={{ color:'black', fontWeight: 'normal' ,textDecoration: 'none' }} to = {{pathname: '/mobile/plans', authenticated: props.authenticated, user: props.user}}>Recharge</Link></MenuItem>
        ...
        <MenuItem><Link style={{ color:'black', fontWeight: 'normal' ,textDecoration: 'none' }} to = {{pathname: '/mobile', authenticated: props.authenticated, user: props.user}}>Plans and Pricing</Link></MenuItem>
        </Menu> 
    </div>
  );
}